...
function OrangeFarmMenu(menu)
    ...
    recolteorange = NativeUI.CreateItem("Récolté des oranges", "")
    ...
    while true do
        ...
        _menuPool:ProcessMenus()
            ...
            if IsEntityAtCoord(PlayerPedId(), 354.65, 6517.87, 28.26, 1.5, 1.5, 1.5, 0, 1, 0) then 
                        ...
                        ESX.ShowHelpNotification("Appuie sur ~INPUT_TALK~ pour récolté des ~b~Oranges")
        ...
        Citizen.CreateThread(function()
            ...
            while true do
                Wait(0)
                    ...
                    local plyCoords = GetEntityCoords(GetPlayerPed(-1), false)
                    if IsEntityAtCoord(PlayerPedId(), 1009.507, -3195.33, -38.99, 1.5, 1.5, 1.5, 0, 1, 0) then 
